...
def smooth(x, window_len=11, window='hanning'):
    ...
    This method utilises the convolution of a scaled window with the _signal.
    The _signal is prepared by introducing reflected copies of the _signal 
    (with the window size) in both ends so that transient parts are minimized
    in the begining and end part of the output _signal.
    
    :param x: the input _signal 
