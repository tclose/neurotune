...
class CurrentClampObjective(Objective):
    ...
    def __init__(self, reference_traces, injected_current, record_variable=None, 
                 time_start=500.0, time_stop=2000.0):
        ...
        self.exp_conditions = ExperimentalConditions(clamps=StepCurrentSource([0, injected_current],
                                                                              [0.0, time_start]))
