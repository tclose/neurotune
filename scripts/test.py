def main():    
    ...
    #     plt.title(str(candidate))
        objective.plot_d_dvdt(recordings, show=False)
        objective.plot_hist(show=False)
        objective.plot_hist(recordings, show=False)
        objective.plot_hist(recordings, diff=True)
